...
Consider the symmetric RW on the “switch” version of $K_N+P_M$ plus the Blackhole; see Figure 5 in the special case $n=5,m=3$. What is the average travel time from $S$ to BH? Express it in terms of $n$ and $m$. Which one is larger: (13) or the solution of the 6-th Homework?
